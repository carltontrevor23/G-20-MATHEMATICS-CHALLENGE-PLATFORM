...
@section('content')
    <div class="full-page register-page section-image" data-color="black" data-image="{{ asset('light-bootstrap/img/full-screen-image-4.jpg') }}">
        <div class="content">
            <div class="container">
                            ...
                            <div class="col-md-5 ml-auto">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>{{ __('Admin Account') }}</h4>
                                        <p>{{ __('This account serves as the control point for managing and overseeing all activities and data within the system.') }}</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <h4>{{ __('System Functionality') }}</h4>
                                        <p>{{ __('Includes user management, challenge management, school management and challenge analytics.') }}</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>{{ __('User-friendly Interface, File Importing and Analytics Visualization.') }}</p>
                                    </div>
                                </div>
                            </div>
