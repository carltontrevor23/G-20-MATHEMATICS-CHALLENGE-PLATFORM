@extends('layouts.app', ['activePage' => 'upload-representatives', 'title' => 'Upload Representatives', 'navName' => 'Upload Representatives', 'activeButton' => 'laravel'])
                    ...
                    <div class="card col-md-8">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h3 class="mb-0">{{ __('Representative Details') }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
