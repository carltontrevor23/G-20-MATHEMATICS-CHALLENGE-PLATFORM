@extends('layouts.app', ['activePage' => 'typography', 'title' => 'Analytics', 'navName' => 'Analytics', 'activeButton' => 'laravel'])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="card ">
                    <div class="card-header ">
                        ...
                        <p class="card-category">{{ __('Performance') }}</p>
                    </div>
                    <div class="card-body ">
                        ...
                        <div class="legend">
                            <ul>
                                @foreach($schools as $schools)
                                    <li>{{ $schools->name }} - {{ $schools->performance_score }}%</li>
                                 @endforeach
                            </ul>
                        ...
                        <hr>
                        <div class="stats">
                            <i class="fa fa-clock-o"></i> {{ __('Ranked according to scores') }}
                        </div>
                    </div>
                </div>
            </div>
            {{-- <div class="col-md-8">
                <div class="card ">
                    <div class="card-header ">
                        <h4 class="card-title">{{ __('Worst Performing Schools Per Challenge') }}</h4>
